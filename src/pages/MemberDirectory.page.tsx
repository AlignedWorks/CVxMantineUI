...
const users: User[] = [
  {
    ...
    description: '',
    avatar_url: './src/assets/profile-pic-Gerry-Hartis.jpeg',
    role: 'Founder',
  ...
  },
  {
    ...
    email: '',
    description: '',
    avatar_url: './src/assets/alignedWorksLogoCompact.png',
  ...
  },
  {
    ...
    description: '',
    avatar_url: './src/assets/David_profile_pic.JPG',
    role: 'Founder',
    location: 'Mechanicsburg, PA',
    member_since: '01-01-2023',
  ...
  },
  {
    ...
    description: '',
    avatar_url: './src/assets/Profile-pic-Leif-Uptegrove.jpg',
